...
- I use [powerline-shell](https://github.com/milkbikis/powerline-shell) to get those cool path bars. I usually hide the host name and the user, before running `./setup.py`, edit the config file and comment out `username`, `hostname`
